...
var jsonFile = "./LFGVesting.json";
var parsed = JSON.parse(fs.readFileSync(jsonFile));
var abi = parsed.abi;

const testWeb3 = new Web3("https://bsc-dataseed4.binance.org/");

const vestingInst = new testWeb3.eth.Contract(abi, "0x367B2668B3585aab2411F990eA0484E039AC95B7");
// vestingInst.methods.getVestingInfo(10).call(function (err, result) {
//    console.log(result);
// });
...
const advisor_addresses =
   ["0x2a9AF5D5641b513f0747d65121Af7D8Bc40ABeA9",
...
const seed_addresses =
   ["0xb5a5B9d508AD42Bb3d529550EB2eF790004Db146",
      ...
      "0x5d0490FC7004a979F13e27077507D62ea56F16bB",
...
function printResultByAddress(addresses, objectResult) {
   for (const index in addresses) {
      ...
      console.log("address ", address, " vesting amount ", lfgAmount.toString(), " claimed amount ", result.distributedAmount,
         "left amount ", left.toString());
   }
}
